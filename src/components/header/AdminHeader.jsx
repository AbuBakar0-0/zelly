                ...
                <nav className="w-full mx-auto bg-white shadow xl:block hidden">
                    <div className="container px-6 h-16 flex items-center lg:items-stretch justify-between mx-auto">
                        ...
                        <ul className="flex items-center justify-center h-full">
                            <NavLink to='/adminfloors' activeClassName="active"><li className="cursor-pointer h-full xl:flex items-center text-sm  tracking-normal hidden">Dashboard</li></NavLink>
                            <NavLink to='/adminshops' activeClassName="active"><li className="cursor-pointer h-full xl:flex items-center text-sm ml-10 tracking-normal hidden hover:text-indigo-700 transition duration-150 ease-in-out">Shops</li></NavLink>
                            ...
                            <NavLink to='/adminproducts' activeClassName="active"><li className="cursor-pointer h-full xl:flex items-center text-sm mr-10 tracking-normal hidden hover:text-indigo-700 transition duration-150 ease-in-out">Products</li></NavLink>
